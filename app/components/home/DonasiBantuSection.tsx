    ...
    <section className="py-12 bg-[#FAF8F5]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative bg-[#7C3131] rounded-2xl overflow-hidden text-white flex flex-col md:flex-row items-stretch justify-between min-h-[320px] shadow-lg">
          {/* Left Content Area */}
          <div className="flex-1 p-8 sm:p-12 z-10 flex flex-col justify-between max-w-7/10">
            <div>
              {/* Title */}
              <h2 className=" md:text-6xl font-extrabold tracking-tight mb-14">
                AYO Bantu Mereka...
              </h2>

              {/* Description Paragraph with Gold Highlighted Text */}
              <p className="text-white/90 font-medium text-sm sm:text-xl leading-relaxed mb-8">
                ...
                lingkungan belajar yang nyaman dan islami dengan donasi terbaik
                Anda hari ini.
              </p>

              {/* Disclaimer / Subtext */}
              <p className="text-white/70 italic text-xs mb-25">
            ...
            <div>
              <Link
                ...
                className="btn-expand-center relative overflow-hidden inline-flex items-center gap-3 
                  bg-[#F8F7F3] text-[#8A3635] text-lg font-semibold px-20 py-4 rounded-sm"
              >
                {/* Right Caret Icon */}
                <svg
                  className="w-4 h-4 text-[#8A3635] transform group-hover:translate-x-1 transition-transform"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
