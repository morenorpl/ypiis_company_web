    ...
    <section className="py-6 bg-[#faf8f500]">
      <div className="max-w-6xl 2xl:max-w-7xl mx-auto px-6 2xl:px-8">
        ...
        <FadeIn delay={0.2} duration={1} y={50} once={true}>
          <div className="relative w-full h-130 2xl:h-145 rounded-3xl border-4 border-[#7C3131] overflow-hidden shadow-md">
            {/* Embedded Interactive Google Map */}
            <iframe
              title="Lokasi Yayasan Pendidikan Islam Imam Syafi’i Berau"
              src={mapEmbedUrl}
              width="100%"
              height="100%"
              style={{ border: 0 }}
